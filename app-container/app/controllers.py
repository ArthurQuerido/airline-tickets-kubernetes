...
# def update_user(json_usuario):
#     Session = sessionmaker(engine)
#     session = Session()     
#     query = (
#             update(Usuario).
#             where(Usuario.id == json_usuario['id']).
#             values(nome = json_usuario['nome'], email = json_usuario['email'])
#     )
